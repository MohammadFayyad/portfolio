        ...
        <section className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-6 py-20 md:px-8 lg:px-10 lg:py-28">
            ...
            >
                <div className="inline-flex w-fit items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm text-zinc-300">
                    ...
                    Building polished product experiences for modern teams
                </div>
                <div className="space-y-4">
                    <h1 className="text-4xl font-semibold tracking-tight text-zinc-50 sm:text-6xl sm:leading-[1.05]">
                        I build calm, high-converting software that feels as good as it performs.
                    </h1>
                    <p className="max-w-2xl text-lg leading-8 text-zinc-400 sm:text-xl">
                        I’m Mohamed Fayad, a software engineer crafting elegant interfaces, scalable products, and thoughtful user journeys.
                    </p>
                </div>
            ...
            <div className="grid gap-4 rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[0_0_0_1px_rgba(255,255,255,0.04),0_30px_80px_rgba(0,0,0,0.35)] md:grid-cols-[1.2fr_0.8fr] md:p-8">
                <div className="flex flex-col justify-between gap-6 rounded-2xl border border-white/10 bg-zinc-900/70 p-6">
                    <div>
                        <p className="text-sm uppercase tracking-[0.3em] text-zinc-500">Current focus</p>
                        <h2 className="mt-3 text-2xl font-semibold text-zinc-100">Designing premium web experiences from idea to launch.</h2>
                    </div>
                    <div className="flex flex-wrap gap-2">
                        {['Next.js', 'TypeScript', 'Framer Motion', 'Tailwind CSS'].map((item) => (
                ...
                <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-zinc-900 to-zinc-800 p-6">
                    <p className="text-sm uppercase tracking-[0.3em] text-zinc-500">Selected impact</p>
                    <div className="mt-6 space-y-4 text-sm text-zinc-300">
                        <div className="flex items-center justify-between border-b border-white/10 pb-3">
                            <span>Product launches</span>
                            <span className="text-xl font-semibold text-zinc-100">12+</span>
                        </div>
                        <div className="flex items-center justify-between border-b border-white/10 pb-3">
                            <span>Years building</span>
                            <span className="text-xl font-semibold text-zinc-100">8+</span>
                        </div>
                        <div className="flex items-center justify-between">
                            <span>Client satisfaction</span>
                            <span className="text-xl font-semibold text-zinc-100">100%</span>
                        </div>
                    </div>
                </div>
            </div>
